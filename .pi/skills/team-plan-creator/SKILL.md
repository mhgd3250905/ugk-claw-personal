...
description: Use when the user asks to create a Team Runtime plan, set up a team for multi-agent task execution, or mentions Chinese phrases like "创建团队计划", "新建团队", "配置执行团队", "运行计划". This skill guides the Agent through creating TeamUnit presets and Plans via the /v1/team REST API.
---

# Team Plan Creator

Use this skill to create Team Runtime v2 plans and team presets through the REST API.
...
```
POST /v1/team/plans/:planId/runs
```

This creates a queued run. The team-worker process picks it up and executes all tasks.
